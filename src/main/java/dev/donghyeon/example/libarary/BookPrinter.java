...
public class BookPrinter {
    ...
    private static final String INSERTED_BOOK_MESSAGE = "추가할 책 이름을 입력하세요. ex) 1,해리포터,민동현";
    private static final String SEARCH_BOOK_MESSAGE = "찾고 싶은 책 ID를 입력하세요.";
    private static final String DELETE_BOOK_MESSAGE = "삭제 하고 싶은 책 ID를 입력하세요.";
    private static final String GUIDE_MESSAGE = "1.책 추가 2.책 삭제 3.책 검색 ";
